const currencyValues = {
  TRY: [
    ...
    67.98, 67.46, 68.52, 68.17, 68.13, 68.5, 68.47, 68.47, 68.5, 68.38, 68.54,
    68.15,
  ],
  PHP: [
    ...
    23.96, 23.85, 24.13, 24.1, 24.1, 24.22, 24.2, 24.2, 24.1, 23.96, 23.98,
    23.82,
  ],
  INR: [
    ...
    15.88, 15.76, 16.01, 15.96, 16.01, 16.12, 16.11, 16.1, 16.08, 16.16, 16.14,
  ],
  ARS: [
    6.69, 6.68, 6.62, 6.58, 6.5, 6.51, 6.6, 6.59, 6.6, 6.52, 6.46, 6.43, 6.47,
    6.41, 6.4, 6.38, 6.36, 6.26, 6.27, 6.27, 6.24, 6.24, 6.25, 6.2, 6.26, 6.22,
    6.21, 6.24, 6.24, 6.19, 6.17, 6.18, 6.14,
  ],
  IDR: [
    ...
    0.0851, 0.0858, 0.086, 0.0862, 0.0866, 0.0864, 0.0879, 0.0879, 0.0879,
    0.087, 0.084, 0.084, 0.086, 0.087, 0.089, 0.0893,
  ],
}
...
const endDate = new Date('2023-04-14')
const dates = []
